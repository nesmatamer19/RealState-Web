...
const About = () => {
  return (
    ...
    mx-auto p-8 md:px-20 lg:px-32 w-full overflow-hidden' id='About'>
      ...
      md:gap-20'>
            <img src={assets.brand_img} className='w-full sm:w1/2 max-w-lg' />
            <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
                ...
                <p className='my-10 max-w-lg'>Explore the best real estate opportunities with our user-friendly platform. Whether you’re buying, selling, or investing, we provide trusted listings, expert advice, and seamless tools to help you find your
